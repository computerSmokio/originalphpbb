...
$sid = (isset($HTTP_COOKIE_VARS[$board_config['cookie_name'] . '_sid'])) ? $HTTP_COOKIE_VARS[$board_config['cookie_name'] . '_sid']: 0;
	...
	{
		if (TRUE or preg_match('/^[a-z_]+$/i', $HTTP_POST_VARS['language']) )
		{
